...
// teacher dash student
app.get('/teacher-stuList', (req, res) => {
    res.render("teacher/showStu", { users });
});

app.get('/teacher-stuList/:classId', (req, res) => {
    const classId = parseInt(req.params.classId);
   
    const studentsInClass = users.filter(user => user.classId === classId);
    res.render("teacher/showStu", { users: studentsInClass });
});
